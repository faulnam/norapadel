        ...
        <div class="receipt">
            ...
            <div class="header">
                <div class="brand">
                    ...
                    <div class="brand-info">
                        ...
                        <p>Jl. Contoh Alamat No. 123, Surabaya</p>
                    </div>
                </div>
            ...
            <div class="address-section">
                <div class="address-box">
                    ...
                    <p class="detail">Jl. Contoh Alamat No. 123</p>
                    <p class="detail">Surabaya, Jawa Timur</p>
                    <p class="detail">Telp: +62 812 3456 7890</p>
                </div>
                <div class="address-box">
                    <h3>Penerima</h3>
            ...
            <div class="schedule-box">
                ...
                <div class="schedule-grid">
                    ...
                    <div class="schedule-item">
                        ...
                        <span>{{ $order->delivery_distance_minutes ?? '-' }} menit</span>
                    </div>
                </div>
            </div>
