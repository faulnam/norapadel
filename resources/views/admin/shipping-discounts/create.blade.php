...
@section('title', 'Tambah Diskon Ongkir')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1" style="font-weight: 700;">Tambah Diskon Ongkir</h4>
        <p class="text-muted mb-0">Buat diskon ongkos kirim baru</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.shipping-discounts.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                               value="{{ old('name') }}" placeholder="Contoh: Promo Akhir Tahun">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="discount_percent" class="form-control @error('discount_percent') is-invalid @enderror" 
                                   value="{{ old('discount_percent', 0) }}" min="0" max="100" step="0.01" placeholder="10">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                          rows="2" placeholder="Deskripsi singkat tentang promo ini">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="max_discount" class="form-control @error('max_discount') is-invalid @enderror" 
                                   value="{{ old('max_discount') }}" min="0" placeholder="50000">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="min_subtotal" class="form-control @error('min_subtotal') is-invalid @enderror" 
                                   value="{{ old('min_subtotal') }}" min="0" placeholder="100000">
                        </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i>Simpan Diskon
                </button>
            </div>
        </form>
    </div>
