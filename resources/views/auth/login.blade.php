    ...
    <section class="flex-1 flex items-center justify-center p-6 md:p-10 overflow-y-auto">
        <div class="w-full max-w-sm">
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('google.login') }}" class="animate-element animate-delay-800 flex w-full items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-white py-2.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50">
