...
@section('title', 'NoraPadel Shoes — Move faster. Play smarter.')
...
<div class="bg-white text-black antialiased">
    ...
    <main class="bg-white pt-16 md:pt-20 lg:pt-32">
        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-10 lg:px-12 py-4 lg:hidden">
            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500">Shoes</p>
            <h1 class="mt-2 text-2xl font-semibold tracking-tight text-black sm:text-3xl">Padel Shoes</h1>
            <p class="mt-2 text-zinc-600 text-sm">Comfortable footwear for optimal performance</p>
        </div>
                    ...
                    <div id="productGrid" class="grid grid-cols-3 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        @empty
                            <div class="col-span-full rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 p-12 text-center">
                                ...
                                <p class="mt-3 font-medium text-zinc-500">Shoes products not available yet.</p>
                            </div>
                        @endforelse
                    </div>
