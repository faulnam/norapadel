...
<div class="bg-white text-black antialiased">
    ...
    <main class="bg-white pt-16 md:pt-20 lg:pt-32">
        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-10 lg:px-12 py-4 lg:hidden">
            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500">New Arrivals</p>
            <h1 class="mt-2 text-2xl font-semibold tracking-tight text-black sm:text-3xl">Latest Products</h1>
            <p class="mt-2 text-zinc-600 text-sm">Discover our newest premium padel equipment</p>
        </div>
