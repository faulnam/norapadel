            ...
            <section class="np-fade-section bg-white pt-2 pb-12 sm:pt-4 sm:pb-14 md:py-16 lg:py-20 transition-all duration-300">
                <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 md:px-10 lg:px-12">
                    <div class="mb-4 flex flex-col gap-4 sm:mb-6 md:mb-8 lg:flex-row lg:items-end lg:justify-between transition-all duration-300">
                        ...
                        <form action="{{ route('apparel') }}" method="GET"
                            class="flex w-full max-w-md items-center gap-2 rounded-full border border-black/10 bg-white p-1.5 shadow-[0_8px_24px_rgba(0,0,0,0.06)]">
                            ...
                            <button type="submit"
                                class="inline-flex h-10 shrink-0 items-center rounded-full bg-zinc-900 px-4 text-sm font-medium text-white transition duration-300 hover:bg-zinc-800">
                                Search
                            </button>
                        </form>
                    </div>
