        ...
        <header class="sticky top-0 z-50 border-b border-black/6 bg-white/80 backdrop-blur-xl">
            <div class="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-6 md:px-10 lg:px-12">
                ...
                <div class="flex items-center gap-4 text-black/80">
                    <a href="{{ route('apparel') }}" class="transition duration-300 hover:text-black" aria-label="Search Apparel">
                    ...
                    @forelse($products as $product)
                        ...
                        >
                            <div class="relative flex h-60 items-center justify-center bg-zinc-50 p-6">
                                <img
                                    src="{{ $product->image ? asset('storage/' . $product->image) : 'https://images.unsplash.com/photo-1518459031867-a89b944bffe4?auto=format&fit=crop&w=900&q=80' }}"
                                    alt="{{ $product->name }}"
