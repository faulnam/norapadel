        ...
        <div class="hidden grid-cols-1 gap-10 sm:grid-cols-2 lg:grid md:grid-cols-3">
            ...
            <div>
                ...
                <div class="mt-4 flex gap-3">
                    <a href="https://instagram.com/{{ config('branding.instagram', '@norapadel.id') }}" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-black transition-all duration-200 hover:bg-pink-500 hover:text-white">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://tiktok.com/@norapadel.id" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-black transition-all duration-200 hover:bg-black hover:text-white">
                        <i class="fab fa-tiktok"></i>
                    </a>
                    <a href="https://shopee.co.id/norapadel" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-black transition-all duration-200 hover:bg-orange-500 hover:text-white">
                        <i class="fas fa-shopping-bag"></i>
                    </a>
                    <a href="https://wa.me/{{ config('branding.whatsapp', '6281277889900') }}" target="_blank" rel="noopener" class="flex h-9 w-9 items-center justify-center rounded-full bg-black/5 text-black transition-all duration-200 hover:bg-green-500 hover:text-white">
